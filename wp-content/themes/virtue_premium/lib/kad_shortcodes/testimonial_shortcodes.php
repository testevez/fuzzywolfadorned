...
function kad_testimonial_shortcode_function( $atts, $content) {
	...
	<div class="home-testimonial">
		<div id="testimonialwrapper-<?php echo esc_attr($id);?>" class="rowtight init-isotope" data-fade-in="<?php echo esc_attr($animate);?>" data-iso-selector=".t_item" data-iso-style="masonry" data-iso-filter="false"> 
            <?php $wp_query = null; 
