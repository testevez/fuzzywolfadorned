	...
	if(empty($id)) {
		...
		if(!empty($caption_caption_bg_color)) { $cc_bg_rgb = ktslidehex2rgb($caption_caption_bg_color);
 		...
 		$custom_slider_css .= '}';
			  	...
			  	<div class="kad-slider-wrapper <?php echo $slider_parallax_class;?> kad-slider-<?php echo $id;?>" data-ktslider-auto-play="<?php echo $auto_play_data;?>" data-ktslider-pause-time="<?php echo $pause_data;?>" data-ktslider-height="<?php echo $data_height;?>" style="max-width:<?php echo $max_width;?>; margin-left: auto; margin-right:auto;">
			    	<div class="kad-slider kad-loading" style="margin-left: auto; margin-right:auto; height:<?php echo $max_height;?>; ">
			            ...
			            <?php foreach ($slides as $slide) : ?>
			                      <li class=""> 
			                              <div class="kad-slide kad-slide-<?php echo $slidenumber;?> <?php echo $textshaddowclass.' '.$headerstyleclass;?>" style="background-image: url('<?php echo $slide['image'];?>'); background-size:cover; background-repeat: no-repeat;">
