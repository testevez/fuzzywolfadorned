...
function kadence_slider_scripts() {
  wp_enqueue_style('kadence_slider_css', KADENCE_SLIDER_URL . 'css/kad-slider.css', false, '104');
  wp_register_script('kadence_slider_js', KADENCE_SLIDER_URL . 'js/min/kadence-slider-min.js', false, 104, true);
...
function kadence_slider_admin_scripts() {
  wp_enqueue_style('kadence_slider_admin', KADENCE_SLIDER_URL . 'css/kad-slider-admin.css', false, '100');
...
new WPUpdatesPluginUpdater_516( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__));
